        ...
        <div>
          ...
          <div className="mt-4">
            ...
            <div className="flex gap-3">
              ...
              <a
                href="https://www.instagram.com/qport.inmotion?igsh=aXI4eXF5cDBya3Iw&utm_source=qr"
                onClick={(e) => {
                  const isMobile = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent);
                  if (isMobile) {
                    e.preventDefault();
                    window.location.href = "https://www.instagram.com/qport.inmotion?igsh=aXI4eXF5cDBya3Iw&utm_source=qr";
                  }
                }}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center w-8 h-8 rounded-lg bg-slate-100 hover:bg-slate-200 transition-colors"
                aria-label="Follow Qport on Instagram"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
