      ...
      <div className="container mx-auto px-4">
        ...
        <section id="mobile-apps" className="mt-32">
          ...
          <div className="mt-12 text-center">
            <p className="text-sm opacity-60 mb-4">Available on iOS and Android</p>
            <div className="flex gap-4 justify-center">
              <div className="px-6 py-3 rounded-lg border border-slate-200 bg-white flex items-center gap-3">
        ...
        {/* ROI Calculator */}
        <section id="roi-calculator" className="mt-32">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-semibold mb-4">Calculate Your ROI</h2>
            <p className="text-lg opacity-70 max-w-3xl mx-auto">
              See how much time and money Qport can save your heavy cargo operations.
            </p>
          </div>

          <div className="max-w-5xl mx-auto rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-600 p-10 text-white">
            <div className="grid gap-8 laptop:grid-cols-2">
              <div>
                <h3 className="text-2xl font-semibold mb-6">Your Current Operations</h3>
                <div className="space-y-6">
                  <div>
                    <label className="block text-sm font-medium mb-2">Monthly Heavy Cargo Deliveries</label>
                    <input
                      type="number"
                      defaultValue="50"
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">Average Route Planning Time (hours)</label>
                    <input
                      type="number"
                      defaultValue="4"
                      className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-white/60 focus:outline-none focus:border-white/40"
                      placeholder="Hours per route"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium mb-2">Route Failure Rate (%)</label>
                    <input
                      type="number"
                      defaultValue="15"
                      className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-white/60 focus:outline-none focus:border-white/40"
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-2">Cost per Failed Delivery ($)</label>
                    <input
                      type="number"
                      defaultValue="5000"
                      className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-white/60 focus:outline-none focus:border-white/40"
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                <h3 className="text-2xl font-semibold mb-6">Estimated Savings with Qport</h3>
                <div className="space-y-6">
                  <div className="pb-4 border-b border-white/20">
                    <div className="text-sm opacity-80 mb-2">Time Saved (Route Planning)</div>
                    <div className="text-3xl font-bold">180 hours/month</div>
                    <div className="text-sm opacity-70 mt-1">90% reduction in planning time</div>
                  </div>
                  <div className="pb-4 border-b border-white/20">
                    <div className="text-sm opacity-80 mb-2">Failed Deliveries Prevented</div>
                    <div className="text-3xl font-bold">7 per month</div>
                    <div className="text-sm opacity-70 mt-1">95% reduction in route failures</div>
                  </div>
                  <div className="pb-4 border-b border-white/20">
                    <div className="text-sm opacity-80 mb-2">Cost Savings</div>
                    <div className="text-3xl font-bold">$35,000/month</div>
                    <div className="text-sm opacity-70 mt-1">From prevented failures alone</div>
                  </div>
                  <div className="pt-2">
                    <div className="text-sm opacity-80 mb-2">Total Annual ROI</div>
                    <div className="text-4xl font-bold text-green-300">$420,000</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-sm opacity-80 mb-4">*Calculations based on industry averages. Actual results may vary.</p>
